  ...
  return (
    <header className="flex items-center justify-between gap-4 px-6 lg:px-8 h-20 shrink-0">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <div className="hidden md:flex items-center gap-2 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl px-3.5 py-2.5 w-64">
          <Search size={16} className="text-[var(--color-text-faint)]" />
          <input
            className="bg-transparent outline-none text-sm placeholder:text-[var(--color-text-faint)] flex-1 min-w-0"
